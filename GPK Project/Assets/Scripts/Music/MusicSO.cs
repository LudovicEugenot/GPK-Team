...
public class MusicSO : ScriptableObject
{
    ...
    [Range(-3f, 3f)] public float calmMusicStartTimeOffset;
    ...
    [Range(-3f, 3f)] public float[] breakMusicStartTimeOffset;
